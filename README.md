# Ontic Redis ![Status](https://img.shields.io/badge/project-maintained-brightgreen.svg)

| Branch             | Build               | Galaxy              | Release              |
| :----------------- | :------------------ | :------------------ | :------------------- |
| **master**         | [![Build](https://img.shields.io/travis/ontic/ansible-role-redis/master.svg)](https://travis-ci.org/ontic/ansible-role-redis) | [![Galaxy](https://img.shields.io/badge/galaxy-ontic.redis-blue.svg)](https://galaxy.ansible.com/ontic/redis/) | [![Release](https://img.shields.io/github/release/ontic/ansible-role-redis.svg)](https://github.com/ontic/ansible-role-redis/releases) |

## Introduction

This role installs Redis on RedHat/CentOS and Debian/Ubuntu Linux servers.
...
```
$ ansible-galaxy install ontic.redis
```
...
```yml
- src: git+https://github.com/ontic/ansible-role-redis.git
  version: master
  name: ontic.redis
```
